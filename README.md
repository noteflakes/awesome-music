...
* [slskd-transform](https://github.com/GeiserX/slskd-transform) - Bulk upgrade music libraries from lossy to lossless FLAC via Soulseek and SLSKD with intelligent duration matching.
